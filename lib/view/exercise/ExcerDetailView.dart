...
class ExcerDetailView extends StatefulWidget {
  ExcerDetailView({Key key, this.topicID}) : super(key: key);
  final String topicID;

  @override
  _ExcerDetailViewState createState() => _ExcerDetailViewState();
}

class _ExcerDetailViewState extends State<ExcerDetailView> {
  var userFullname;
  var uid;
  ...
  Future<List<AllList>> postNewsDetail(
    ...
    final response = await client.post(Uri.parse(Info().ExerDetail),
