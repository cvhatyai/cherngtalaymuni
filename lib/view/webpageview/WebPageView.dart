  ...
  gotoPage() {
    ...
    if (widget.cmd == "tax") {
      ...
      url_service = Info().baseUrl +
          ...
          Info().baseUrl +
          "electricity/?app=1";
    } else if (widget.cmd == "publicworks") {
      url_service = Info().baseUrl +
          'app_api_v1/authentication?authen_token=' +
          user.authen_token +
          "&redirect=" +
          Info().baseUrl +
          "publicworks/?app=1";
    } else if (widget.cmd == "sewage_registration") {
      url_service = Info().baseUrl +
          'app_api_v1/authentication?authen_token=' +
          user.authen_token +
          "&redirect=" +
          Info().baseUrl +
          "sewage_registration/?app=1";
    ...
    } else if (widget.cmd == "publicworks_admin") {
      if (widget.edit != "") {
        url_service = Info().baseUrl +
            'app_api_v1/authentication?authen_token=' +
            user.authen_token +
        ...
        url_service = Info().baseUrl +
            ...
            "&redirect=" +
            Info().baseUrl +
            "behind/publicworks/showList?app=1";
      }
    } else if (widget.cmd == "sewage_registration_admin") {
      if (widget.edit != "") {
        url_service = Info().baseUrl +
            'app_api_v1/authentication?authen_token=' +
            user.authen_token +
            "&redirect=" +
            Info().baseUrl +
            "behind/sewage_registration/edit/" +
            widget.edit +
            "?app=1";
      } else {
        url_service = Info().baseUrl +
            ...
            "&redirect=" +
            Info().baseUrl +
            "behind/sewage_registration/showList?app=1";
      }
      ...
      if (widget.edit != "") {
        ...
        url_service = Info().baseUrl +
            ...
            "&redirect=" +
            Info().baseUrl +
            "behind/water_garbage/showList?app=1";
      }
