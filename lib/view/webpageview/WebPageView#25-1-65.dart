...
class _WebPageViewState extends State<WebPageView> {
  ...
  checkCmd() {
    var thisCmdNeedCitizen = ["tax", "garbage", "elder", "disabled", "hiv"];
  ...
  gotoPage() {
    ...
    if (widget.cmd == "tax") {
      ...
      url_service = Info().baseUrl + "content/information/1/?app=1";
    }
    ///////////////////////////////////////////////////////////
  ...
  backPageView() {
    ...
    print('uribackpageview ${urigoback}');
    if (urigoback == 'formselect?app=1' ||
