...
class SignInLine {
  void lineSDKInit() async {
    await LineSDK.instance.setup("1656764107").then((_) {
...
class _LoginViewState extends State<LoginView> {
  ...
  Future<void> _loginGoogle() async {
    _googleSignIn.onCurrentUserChanged.listen((GoogleSignInAccount account) {
      ...
      print('_currentUser1 : ' + _currentUser.toString());
      _currentUser = account;
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(Color(0xFF5A1E8E)),
                    ),
                    onPressed: () {
                      setState(() {
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          color: Color(0xFFFFF600),fontSize: 16),
                    ),
                  ),
                ),
