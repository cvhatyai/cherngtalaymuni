...
class SignInLine {
  void lineSDKInit() async {
    await LineSDK.instance.setup("1656383523").then((_) {
...
class _SettingViewState extends State<SettingView> {
  ...
  updateData() async {
    if (isSwitched) {
      user.isNoti = "1";
      firebaseMessaging.subscribeToTopic("th.go.cherngtalaymunicity");
      firebaseMessaging.subscribeToTopic("news");
    } else {
      user.isNoti = "";
      firebaseMessaging.unsubscribeFromTopic("th.go.cherngtalaymunicity");
                  ...
                  child: Ink(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFF5A1E8E),Color(0xFF5A1E8E)],
                      ),
                      borderRadius: BorderRadius.circular(9),
                    ),
                    child: Container(
