...
class _SuggustViewState extends State<SuggustView> {
  ...
  Widget build(BuildContext context) {
    ...
    final double itemHeight = (size.height - kToolbarHeight - 24) / 5.6;
    final double itemWidth = size.width / 2;
    return Container(
      // color: Color(0xFFf5f6fa),
      decoration: new BoxDecoration(
        image: new DecorationImage(
          image: new ExactAssetImage('assets/images/bg_toprec.png'),
          fit: BoxFit.fitWidth,
        ...
        children: [
          Container(
            ...
            child: Container(
              ...
              child: Text(
                "แนะนำสำหรับคุณ",
                style: TextStyle(color: Color(0xFF4283C4), fontSize: 18,fontFamily: 'Sriracha'),
              ),
            ),
          ),
          Container(
